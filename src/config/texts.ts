  ...
  career: [
    ...
    },
    {
      ...
      experience: [
        ...
        "Atendimento de suporte hotline internacional aos colaboradores globais combase no timezone",
        "Administração de infraestrutura de rede e servidores, controle de acesso egerenciamento de usuários",
        ...
        "Produção de documentação técnica e instruções internas para padronização deprocessos",
        "Gerenciamento de ciclo de vida de ativos de TI, gestão orçamentária e aquisiçãode equipamentos",
      ],
    },
  ],
  projects: {
